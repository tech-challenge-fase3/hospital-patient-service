...
public interface PatientControllerDocs {
    ...
    @Operation(
            ...
            description = "Salva os dados de um novo paciente, provisiona sua identidade no Keycloak usando a senha informada e valida duplicidade de CPF e e-mail."
    )
    @ApiResponses(value = {
        @ApiResponse(
                responseCode = "201",
    ...
    ResponseEntity<PatientResponseDTO> register(
